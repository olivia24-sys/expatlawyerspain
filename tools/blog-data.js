...
module.exports = {
  ...
  pages: {
    ...
    property: {
      ...
      description: 'Guides to buying property in Spain: taxes, conveyancing, NIE numbers and the legal checks foreign buyers need before signing or paying a deposit.',
    ...
    tax: {
      ...
      description: 'Spanish property taxes, capital gains tax, non-resident obligations and the Beckham Law, explained in plain English for foreign owners and residents.',
    ...
    admin: {
      ...
      description: 'NIE numbers, TIE cards, bank accounts and the admin steps every expat needs in Spain, before you buy, relocate or hire a lawyer.',
    ...
    'moving-to-spain': {
      ...
      description: 'Legal checklists, visa guides and practical advice for people relocating to Spain from the UK, US and beyond, covering the first legal steps expats need.',
    ...
    wills: {
      dir: 'wills',
      badge: 'Most read guide',
      title: 'Wills & Inheritance Guides in Spain | ExpatLawyerSpain',
      description: 'Inheritance law, Spanish wills and estate planning for expats who own property or assets in Spain, and how regional rules and taxes affect your family.',
