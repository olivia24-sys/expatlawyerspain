...
const { parseFirms: parseFirmsShared } = require('./lib/parse-firms.js');
...
// Extraction now lives in tools/lib/parse-firms.js (shared with
// build-widget-data.js). Same fields, same fail-loud behaviour via die().
function parseFirms() {
  return parseFirmsShared({ root: ROOT, die });
}
